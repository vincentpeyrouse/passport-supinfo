...
Strategy.prototype._parseProfileExt = function(params) {
  ...
  if (profile.role === 'Student') {
    switch (params.PersonCursus.split(';')[1]) {
      case '1':
        profile.level = 'B1' + params.PersonClasse;
        break;
      case '2':
        profile.level = 'B2' + params.PersonClasse;
        break;
      case '3':
        profile.level = 'B3' + params.PersonClasse;
        break;
      case '4':
        profile.level = 'M1' + params.PersonClasse;
        break;
      case '5':
        profile.level = 'M2' + params.PersonClasse;
        break;
      default:
        profile.level = 'N/A';
        break;
